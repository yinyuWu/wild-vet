...
var AmplifyAmazonButton = function () {
  ...
  class_1.prototype.signInWithAmazon = function (event) {
    ...
    window['amazon'].Login.authorize({
      ...
      try {
        window.localStorage.setItem(_constants_ee3a6e1d_js__WEBPACK_IMPORTED_MODULE_5__["i"], JSON.stringify({
          provider: 'amazon'
        }));
      } catch (e) {
  ...
  function class_2(hostRef) {
    ...
    this.handleLoad = function () {
      ...
      _this._auth0.parseHash(function (err, authResult) {
        ...
        try {
          localStorage.setItem(_constants_ee3a6e1d_js__WEBPACK_IMPORTED_MODULE_5__["i"], JSON.stringify(payload));
        } catch (e) {
